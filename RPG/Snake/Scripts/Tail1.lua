...
update = function(e)
	...
	if other ~= "" and alive then
		if e:GetEntity(other):GetCC():GetType() == "Player2" or e:GetEntity(other):GetCC():GetType() == "Tail2" then
...
recieveSignal = function(e, signal)
	...
	if signal == "1blue" then
		color = "blue" 
	end
	if signal == "1yellow" then
		color = "yellow" 
	end
...
recieveMessage = function(e, message)
	...
	if message == "Eat" then
		...
		elseif tailed ~= "" then
			...
			t = e:CreateEntity( x, y, "Tail1", e:GetName() )
			tailed = t
		end
	end
