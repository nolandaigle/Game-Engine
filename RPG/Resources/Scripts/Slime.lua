...
bang = function(e)
	...
	dialogue:PushMessage("OH GOD WHAT HAVE I \nBECOME?")
	dialogue:PushMessage("Ha... Ha...\n Just kidding.")
	dialogue:PushMessage("Did you know there's\n a graveyard to the EAST\n of here?")
	dialogue:PushMessage("I went to visit my mom but...\n None of the spirits were\n there.")
